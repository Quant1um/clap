...
enum {
   ...
   // (a reasonable implementation could check if the output is less than a threshold for an extended period of time)
   ...
   // 
   // It is illegal to return this status code unless both the plugin and the host implement the 'tail' extension.
   CLAP_PROCESS_TAIL = 3,

   // Processing succeeded, it is safe to stop processing without causing a significant truncation of the audio output.
   //
   // Processing will be resumed by:
